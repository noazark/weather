...
(function() {
  var URL, Weather, http, isModule, isOnDate, maxBy, minBy;
  ...
  maxBy = Weather.Utils.maxBy = function(list, iterator) {
    var f, max;
    max = null;
    f = function(memo, d) {
      var val;
  ...
  minBy = Weather.Utils.minBy = function(list, iterator) {
    var f, min;
    min = null;
    f = function(memo, d) {
      var val;
  ...
  isOnDate = Weather.Utils.isOnDate = function(a, b) {
    var sameDate, sameMonth, sameYear;
